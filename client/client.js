...
function renderSeatIndicator(sid,gs,players){
  ...
  if(gs.gameStatus==='game_over'){
    ...
    const dBJ=score(gs.hands?.dealer||[])===21&&(gs.hands?.dealer||[]).length===2&&gs.dealerRevealed;
    ...
    if(dBJ&&wasInsured){
      ...
      ind.innerHTML='<svg viewBox="0 0 40 46" fill="none" width="28" height="32"><path d="M20 2 L37 9 L37 24 C37 35 20 44 20 44 C20 44 3 35 3 24 L3 9 Z" fill="rgba(200,134,10,0.3)" stroke="#c8860a" stroke-width="2"/><polyline points="12,23 18,30 29,17" stroke="#c8860a" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg>';
