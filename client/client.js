...
if(betTimerToggle){betTimerToggle.addEventListener('click',()=>{betTimerEnabled=!betTimerEnabled;betTimerToggle.classList.toggle('on',betTimerEnabled);socket.emit('setBetTimerEnabled',{enabled:betTimerEnabled});sfxClick();});}
