...
function doAction(action){
  ...
  // Override the sind-N indicator with colored action symbol
  {
    ...
    const SPLIT_SVG='<svg width="22" height="16" viewBox="0 0 28 20" fill="none" stroke="#42a5f5" stroke-width="2.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="10,4 2,10 10,16"/><polyline points="18,4 26,10 18,16"/></svg>';
    const overrideHTML=
    ...
    if(overrideHTML){
      ...
      if(ind&&!ind.classList.contains('sind-bust')){
        ...
        _sindOverride[sid]={tok,active:true};
        ...
        // Restore after 1.5s MAX or immediately when animateScoreUpdate fires a new value
